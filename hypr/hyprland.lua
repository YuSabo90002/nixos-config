...
-- "silent" を付けるとウィンドウを ws10 に送るだけでフォーカスは移らない (起動時に ws10 へ飛ばされないように)
hl.window_rule({ name = "discord-ws",         match = { class = "discord" },                        workspace = "10 silent" })
hl.window_rule({ name = "pear-desktop-ws",    match = { class = "com.github.th-ch.youtube-music" }, workspace = "10 silent" })
